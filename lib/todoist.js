...
const TOKEN_PROXY_URL = 'https://focus-extension-proxy.isaacaimdrone.workers.dev/api/todoist/token';

// Todoist OAuth Client ID (public — safe to include in extension code)
const TODOIST_CLIENT_ID = '5452c5e3699e449680b216fad4d60ee2';
