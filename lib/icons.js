...
const Icons = {
  ...
  playCircle: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polygon points="10 8 16 12 10 16 10 8"/></svg>`,
  ...
  ban: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><line x1="4.93" y1="4.93" x2="19.07" y2="19.07"/></svg>`,
  ...
  radiation: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/><line x1="4.93" y1="4.93" x2="9.17" y2="9.17"/><line x1="14.83" y1="14.83" x2="19.07" y2="19.07"/><line x1="14.83" y1="9.17" x2="19.07" y2="4.93"/><line x1="4.93" y1="19.07" x2="9.17" y2="14.83"/></svg>`,
  ...
  timer: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="13" r="8"/><path d="M12 9v4l2 2"/><path d="M5 3 2 6"/><path d="m22 6-3-3"/><path d="M6.38 18.7 4 21"/><path d="M17.64 18.67 20 21"/><path d="M9 2h6"/><path d="M12 2v3"/></svg>`,
  ...
  // Weather icons (Phosphor - from CDN)
...
// Profile icon mapping (for the picker)
const PROFILE_ICON_OPTIONS = [
  { id: 'target', name: 'Target', icon: Icons.target },
  { id: 'briefcase', name: 'Work', icon: Icons.briefcase },
  { id: 'book', name: 'Study', icon: Icons.book },
  { id: 'sun', name: 'Relaxed', icon: Icons.sun },
  { id: 'coffee', name: 'Break', icon: Icons.coffee },
  { id: 'home', name: 'Home', icon: Icons.home },
  { id: 'shield', name: 'Focus', icon: Icons.shield },
  { id: 'zap', name: 'Energy', icon: Icons.zap },
  { id: 'star', name: 'Star', icon: Icons.star },
  { id: 'heart', name: 'Health', icon: Icons.heart },
  { id: 'flame', name: 'Streak', icon: Icons.flame },
  { id: 'clock', name: 'Timer', icon: Icons.clock },
  { id: 'award', name: 'Award', icon: Icons.award },
  { id: 'trophy', name: 'Trophy', icon: Icons.trophy },
  { id: 'lightbulb', name: 'Ideas', icon: Icons.lightbulb },
  { id: 'eye', name: 'Watch', icon: Icons.eye },
  { id: 'lock', name: 'Lock', icon: Icons.lock },
  { id: 'ban', name: 'Block', icon: Icons.ban },
  { id: 'check', name: 'Done', icon: Icons.check },
  { id: 'list', name: 'Tasks', icon: Icons.list },
];

// Category icon mapping
const CATEGORY_ICONS = {
  'social-media': Icons.messageCircle,
  ...
  'forums': Icons.users,
  'productivity': Icons.briefcase,
  'education': Icons.graduationCap,
  'email': Icons.mail,
  'default': Icons.folder,
};

// Category icon options (for the picker)
const CATEGORY_ICON_OPTIONS = [
  { id: 'folder', name: 'Folder', icon: Icons.folder },
  { id: 'messageCircle', name: 'Social', icon: Icons.messageCircle },
  { id: 'playCircle', name: 'Video', icon: Icons.playCircle },
  { id: 'newspaper', name: 'News', icon: Icons.newspaper },
  { id: 'gamepad', name: 'Gaming', icon: Icons.gamepad },
  { id: 'shoppingCart', name: 'Shopping', icon: Icons.shoppingCart },
  { id: 'users', name: 'Forums', icon: Icons.users },
  { id: 'briefcase', name: 'Work', icon: Icons.briefcase },
  { id: 'graduationCap', name: 'Education', icon: Icons.graduationCap },
  { id: 'mail', name: 'Email', icon: Icons.mail },
  { id: 'ban', name: 'Block', icon: Icons.ban },
  { id: 'clock', name: 'Time', icon: Icons.clock },
  { id: 'star', name: 'Star', icon: Icons.star },
  { id: 'heart', name: 'Health', icon: Icons.heart },
  { id: 'coffee', name: 'Break', icon: Icons.coffee },
  { id: 'eye', name: 'Watch', icon: Icons.eye },
...
function getIcon(iconId) {
  return Icons[iconId] || Icons.target;
}
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { Icons, PROFILE_ICON_OPTIONS, CATEGORY_ICONS, CATEGORY_ICON_OPTIONS, getIcon, getCategoryIcon };
}
